...
# Retained dedicated-UI-runspace Canvas experiment.
...
$UiApplicationState.AndroidCanvasEdge = $edge
$UiApplicationState.ScriptRunspace = [System.Management.Automation.Runspaces.Runspace]::DefaultRunspace
$UiApplicationState.UiStateManagedIdentityHashOnScriptThread =
    [System.Runtime.CompilerServices.RuntimeHelpers]::GetHashCode($UiApplicationState)
$UiApplicationState.ScriptPid = [Android.OS.Process]::MyPid()
$UiApplicationState.ScriptTid = [Android.OS.Process]::MyTid()
$script:Dirty = $true
...
[Action] $attach = [Action]{
    $UiApplicationState.UiStateManagedIdentityHashOnAndroidMain =
        [System.Runtime.CompilerServices.RuntimeHelpers]::GetHashCode($UiApplicationState)
    $UiApplicationState.AndroidMainPid = [Android.OS.Process]::MyPid()
    $UiApplicationState.AndroidMainTid = [Android.OS.Process]::MyTid()
    $UiApplicationState.AndroidMainLooper = [object]::ReferenceEquals(
    ...
    $UiApplicationState.Surface = $surface
    $UiApplicationState.EdgeSurfacePublishedSurfaceManagedReferenceEqualOnAndroidMain =
        [object]::ReferenceEquals($edge.Surface, $UiApplicationState.Surface)
    ...
    [Android.Util.Log]::Info('PowerShell',
        "DEDICATED_UI_RUNSPACE_ATTACHED scriptTid=$($UiApplicationState.ScriptTid) androidMainTid=$($UiApplicationState.AndroidMainTid) androidMainLooper=$($UiApplicationState.AndroidMainLooper) uiRunspaceManagedIdentityHash=$([System.Runtime.CompilerServices.RuntimeHelpers]::GetHashCode($UiRunspace)) uiStateManagedIdentityHash=$($UiApplicationState.UiStateManagedIdentityHashOnAndroidMain) edgeManagedIdentityHash=$([System.Runtime.CompilerServices.RuntimeHelpers]::GetHashCode($edge)) surfaceManagedIdentityHash=$([System.Runtime.CompilerServices.RuntimeHelpers]::GetHashCode($surface)) edgeSurfacePublishedSurfaceManagedReferenceEqual=$($UiApplicationState.EdgeSurfacePublishedSurfaceManagedReferenceEqualOnAndroidMain)")
}.GetNewClosure()

$service.RunOnMainThread($activity, $UiRunspace, $attach)
